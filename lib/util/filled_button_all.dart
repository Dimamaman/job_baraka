...
class FilledButtonAll extends StatelessWidget {


  final dynamic Function()? onPress;

  const FilledButtonAll(
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: FilledButton(
          ...
          child: Text(LocaleKeys.login_text_button.tr(), style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 16,color: Colors.white),)),
    );
  }
}
